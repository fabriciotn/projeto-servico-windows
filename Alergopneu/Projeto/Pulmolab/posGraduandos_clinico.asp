...
<div id="geral">
	<div id="centro"> 
		...
		<div id="texto">
			<div id="titulo_centro"><img src="img/titulo_posgraduandos.png" border="0" /></div>
			<div id="texto_centro">
<!--				<p>Para conhecer os ex-integrantes. <span class="link"><a href="ex_corpoclinico.asp">Clique aqui</a></span></p>-->
				...
				<table width="350" border="0">
					...
					<%
						SQL = "SELECT"
						SQL = SQL & " cat.nome AS nomeCategoria, s.nome AS nomeSetor, upper(c.nome) as nome, c.email, c.foto, c.universidade, c.formaturaGraduacao, c.atividade, c.residenciaPediatria,"
						...
						SQL = SQL & " WHERE aprovado <> 0 AND categoria = 3"' OR categoria = 3 OR categoria = 4 )"
...
'						Response.End()
					...
					%>
							<tr>
								...
								<%ELSEIF setor = "" AND nomeCategoria <> categoria_anterior THEN%>
							...
							<tr>
							  <td>  
								...
								<div id="info_andre" align="justify" class="conteudo"> <br />
							...
							<%
									categoria_anterior = rs("nomeCategoria")
