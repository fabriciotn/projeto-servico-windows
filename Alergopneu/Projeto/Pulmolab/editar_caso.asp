...
Session("usuario") = usuario
				...
				SQL = "select * from casoclinico where cod="&cod
...
<form method="post" action="editar_caso_ok.asp">
	<table style="font-family: Tahoma; font-size: 8pt;">
		...
		<tr>
			<td colspan="4" class="area"><input type="text" name="autor" id="autor" size="51" value="<%=rs("autor")%>" /></td>
		</tr>
		<tr>
			<td colspan="4" class="area"><b>Data: </b></td>
		</tr>
		<tr>
			<td colspan="4" class="area"><input type="text" name="data" id="data" class="data" size="21" value="<%=data%>" /></td>
		</tr>
		<!--<tr>
		...
		<tr>
			<td colspan="4" class="area">
				<textarea name="texto" id="texto"  style="width: 328px; height: 200px;"><%=texto%></textarea>
			</td>
		</tr>	
		<tr>
			<td colspan="4">
