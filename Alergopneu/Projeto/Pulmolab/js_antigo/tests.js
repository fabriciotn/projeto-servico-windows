...
var jxSkins = [
    {label: 'Delicious Theme', skin: 'delicious', image: 'http://jxlib.org/reference/examples/images/delicious.png', active: false},
    {label: 'Crispin Theme', skin: 'crispin', image: 'http://jxlib.org/reference/examples/images/crispin.png', active: false}
];
...
jxSkins.each(function(skin, i) {
    ...
    new Asset.css('http://jxlib.org/lib/themes/'+skin.skin+'/jxtheme.css', {
        rel: rel,
        title: skin.label
    });
    if (Browser.Engine.trident4) {
        new Asset.css('http://jxlib.org/lib/themes/'+skin.skin+'/ie6.css', { rel: 'stylesheet' });
    }
    if (Browser.Engine.trident5) {
        new Asset.css('http://jxlib.org/lib/themes/'+skin.skin+'/ie7.css', { rel: 'stylesheet' });
    }
});
        ...
        if (p.id) {
            ...
            new Jx.Toolbar({scroll:false}).add(
                new Jx.Button.Flyout({
                    ...
                    image: 'http://jxlib.org/reference/examples/images/script.png',
