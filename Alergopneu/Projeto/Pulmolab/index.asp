...
%>
					<div id="fundo_fotocorpoclinico"><img src="<%=foto%>" width="60" height="80" style="margin-top:1px;" /></div>
			...
			<div id="bloco">
				...
				<div id="fundo1">				
					<a href="http://pneumoalergoped2014.com.br/"><img src="img/logo_jornada.png" style="padding:10px" width="305" height="175" border="0" /></a>
				</div>
			</div>
