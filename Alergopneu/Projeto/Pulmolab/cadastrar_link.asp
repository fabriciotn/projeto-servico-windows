...
<br />
<form method="post" action="cadastrar_link_ok.asp">
	<table style="font-family: Tahoma; font-size: 8pt;">
		...
		<tr>
			<td colspan="4" class="area"><b>P&aacute;gina:</b></td>
		</tr>
		<tr>
			<td colspan="4" class="area"><input type="text" name="pagina" id="pagina" size="51"/></td>
		</tr>
		<tr>
			<td colspan="4">
				<b>Aten&ccedil;&atilde;o:</b> Digite aqui a URL da página por exemplo: http://www.google.com.br/
			</td>
		</tr>
		<tr>
			<td class="area">&nbsp;</td>
		...
		<tr>
			<td colspan="4" class="area">
				<input type="text" name="texto" id="texto" style="width: 350px; height: 20px; font-size:12px;"/>
			</td>
		</tr>	
		<tr>
			<td colspan="4">
