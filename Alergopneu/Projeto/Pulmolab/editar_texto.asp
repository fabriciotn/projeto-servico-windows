...
<%
				...
				SQL = "select * from textos where cod="&cod
...
<form method="post" action="editar_texto_ok.asp">
	<table>
		<tr>
			<td colspan="4" class="area"><b>T&iacute;tulo:</b></td>
		</tr>
		<tr>
			<td colspan="4" class="area"><input type="text" name="titulo" id="titulo" size="70" value="<%=rs("titulo")%>" /></td>
		</tr>
		<tr>
			<td class="area">&nbsp;</td>
			<td colspan="3">&nbsp;</td>
		...
		<tr>
			<td colspan="4" class="area">
				<textarea name="texto" id="texto" style="width: 450px; height: 300px; font-size:12px;"><%=texto%></textarea>
			</td>
		</tr>	
		<tr>
			<td colspan="4">
