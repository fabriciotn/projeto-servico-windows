...
<%
				...
				SQL = "SELECT cod, titulo, texto, arquivo, data FROM casoclinico WHERE cod = "& cod 
'				Response.Write(sql)
...
<%=noticia%><br />
<p class="destaque_vermelho"><span class="link"><a href="casoclinico/<%=arquivo%>" target="_blank"><%=Server.HTMLEncode(rs("titulo"))%></a></span></p>
</div>
