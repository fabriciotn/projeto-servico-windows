       ...
       <form name="form" id="form" method="post" id="auto"  ENCTYPE="multipart/form-data">
            ...
            <legend style="font-weight:bold;" border="0">Escolha os Filtros</legend>
                  <table class="filtro">
                   ...
                   <tr>
                      <td><div class="form-rotulo2">Empresa:</div></td>
                   <td>
        	      <div class="form-campos2">
                       <input style="text-align:left;width:300px;" maxlength="255" type="text" name="loja" id="loja" value="'.$_POST['loja'].'"/>
        	      </div>
        	    </td>
                    <td><div class="form-rotulo2">Gerar arquivo:&#160;&#160;&#160;</div></td>
                    <td>
        	      <div class="form-campos2">
...
$html = '<div class="tipo_dados" align="center">Estoque ( '.date("d/m/Y").' )</div>
          <table class="separate">
              <thead>
                <tr>
                       ...
                       <th width="100px">Preço Revenda</th>
                       <th width="100px">Qde Comprada</th>
                       <th width="100px">Qde Utilizada</th>
                       <th width="100px">Saldo</th>
                       <th width="100px">Qde Mínima</th>
                       <th width="150px">Consumo Médio (dia)</th>

	                </tr>
                   </thead>
                   <tbody>';
                   $html .= RelatorioEstoque();
                   $html .= '</tbody>
            </table>
