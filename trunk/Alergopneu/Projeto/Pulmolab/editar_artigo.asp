...
Session("usuario") = usuario
				...
				SQL = "select cod, titulo, texto, comentario from artigos where cod="&cod
...
<form method="post" action="editar_artigo_ok.asp">
	<table style="font-family: Tahoma; font-size: 8pt;">
		...
		<tr>
			<td colspan="4" class="area">
				<textarea name="comentario" id="comentario" style="width: 328px; height: 100px;"><%=comentario%></textarea>
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
