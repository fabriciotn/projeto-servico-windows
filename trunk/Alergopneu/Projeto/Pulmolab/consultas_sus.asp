...
<div id="centro"> 
       ...
       <div id="texto">
       <div id="titulo_centro"><img src="img/titulo_consultasus.png" width="141" height="16" border="0" /></div>
       
       <div id="texto_centro">
     <%

'	tipo 4 = tipo consulta sus

	sqlTextos = "SELECT titulo, texto, cod FROM textos WHERE tipo = 4 ORDER BY cod DESC LIMIT 1"
