                  ...
                  <table class="filtro">
                   ...
                   <td width="150px;">
                    ...
                    <td>
                        ...
                        <td>
        		                <div class="form-rotulo2">Ítem:</div>
                        </td>
                        <td>
        		                <div class="form-campos2">
                                  <input style="text-align:left;width:300px;" maxlength="255" type="text"
                                  name="item" id="item" value="'.$_POST['item'].'"/>
        		        </div>
        		        </td>
                     </tr>
        		    <tr>
                        <td>
        		           <div class="form-rotulo2">Serviço Executado</div>
                        </td>
                        <td>
        		                <div class="form-campos2">
                                  <input style="text-align:left;width:300px;" maxlength="255" type="text"
                                  name="servicoExecutado" id="servicoExecutado" value="'.$_POST['servicoExecutado'].'"/>
        		        </div>
        		        </td>
    		        </tr>
    		        <tr>
                        ...
                        <td>
        		           <div class="form-rotulo2">Tipo de Produção:</div>
        		        </td>
                        <td>
        		                <div class="form-campos2">
                                  <select name="idTipoProducao" id="idTipoProducao">
                                  <option value="" selected="selected"></option>';
                        $filtro .= comboTipoProducao();
                        $filtro .= '</select>
        		        </div>
        		        </td>
        		        <td>
...
$html = '<div class="tipo_dados" align="center">Produção Realizada de '.$dataInicio.' a '.$dataTermino.'</div>
          <table class="separate">
              <thead>
                <tr>
                       <th width="19px">Nº</th>
                       <th width="38px"> OS</th>
                       <th width="120px">Código Barras</th>
                       <th width="300px"> Ítem</th>
                       <th width="300px"> Serviço Executado</th>
                       <th width="250px">Funcionário Produção</th>
                       <th width="120px">Data Produção</th>
                       <th width="120px">Nome da Empresa</th>
	                </tr>
                   </thead>
                   <tbody>';
                   $html .= RelatorioProducao();
                   $html .= '</tbody>
            </table>
