...
$(document).ready(function(){
  ...
  <div id="sgi-conteudo">
       ...
       <form name="form" id="form" method="post" id="auto"  ENCTYPE="multipart/form-data">
            <div class="tipo_dados" align="center">Contas Pagas</div>
                 <br>
                 <hr>
                 <br>
                  <table>
                          ...
                          <table class="sortable" width="95%">
                            <thead>
                             <tr class="header-list">
                                 ...
                                 <th width="500" style="vertical-align:text-bottom;" align="left">Pago a</th>
