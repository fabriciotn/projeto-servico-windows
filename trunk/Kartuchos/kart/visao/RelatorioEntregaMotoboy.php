<?php
    ...
    $titulo1 = "Relatório de Entregas por Motoboy";
                  ...
                  <table class="filtro">
                   ...
                   <td width="150px;">
    		        ...
    		        <tr>
                        ...
                        <td>
        		           <div class="form-rotulo2"><label for="motoboy">Motoboy Entrega:</label></div>
        		        </td>
                        <td>
        		                <div class="form-campos2">
                                  <input style="text-align:left;width:300px;" maxlength="255" type="text"
                                  name="motoboy" id="motoboy" value="'.$_POST['motoboy'].'"/>
        		        </div>
        		        </td>
        		        <td>
...
$html = '<div class="tipo_dados" align="center">Entregas Realizadas de '.$dataInicio.' a '.$dataTermino.'</div>
          <table class="separate">
              <thead>
                <tr>
                       ...
                       <th width="94px">Data Entrega</th>
                       <th width="38px">Motoboy Coleta</th>
                       <th width="20px">Motoboy Entrega</th>
                       <th width="94px">Status</th>
	                </tr>
                   </thead>
                   <tbody>';
                   $html .= RelatorioEntregaMotoboy();
                   $html .= '</tbody>
            </table>
