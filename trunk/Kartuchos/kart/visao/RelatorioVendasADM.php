<?php
    ...
    $titulo1 = "Relatório de Vendas Detalhado";
                   ...
                   <td width="150px;">
    		        ...
    		        <tr>
                        ...
                        <tr>
                          <td></td><td></td>
                          <td colspan="2">
                           <input type="radio" id="tipoVenda" name="tipoVenda" ';
                           if($_POST["tipoVenda"] == "1") $filtro .= 'checked';
                           $filtro .= ' value="1" />&nbsp;&nbsp;&nbsp;Locação
                           &nbsp;&nbsp;&nbsp;
                           <input type="radio" id="tipoVenda" name="tipoVenda" ';
                           if($_POST["tipoVenda"] == "2") $filtro .= 'checked';
                           $filtro .= ' value="2" />&nbsp;&nbsp;&nbsp;Contrato
                           &nbsp;&nbsp;&nbsp;
                           <input type="radio" id="tipoVenda" name="tipoVenda" ';
                           if(!$_POST["tipoVenda"] or $_POST["tipoVenda"] == "0") $filtro .= 'checked';
                           $filtro .= ' value="0" />&nbsp;&nbsp;&nbsp;Nenhum
                           &nbsp;&nbsp;&nbsp;
                         </td>
                         <td>
          ...
          <table class="separate">
              <thead>
                <tr>
                       ...
                       <th width="80px">Tipo de Venda</th>
                       <th width="80px">Desconto ou Majorado</th>
