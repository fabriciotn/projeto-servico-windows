<?php
     ...
     if($_GET['CRUD'])
     {
      //if(verificaAlteracao(2, $_SESSION["cod"]))
         CRUDCliente();
      //else
            ...
            <div class="form-linha2">
                          <div class="form-rotulo2">Digite a nome:</div>
                                ...
                                <span style="border: 0px;padding: 0px; position: absolute;">
                                  <a href="#"><img onClick="Envia('<?php echo $PHP_SELF; ?>?acao=lista<?php if($_GET['locacao']) echo "&locacao=1";?>');" src="images/icons/seguir.png" style="border: 0px;padding: 0px;" alt="Pesquisar"/></a>
                               <?php
                                  if(!$_GET['locacao'])
                                  {
                                  ?>
     ...
     <table>
                   ...
                   ?>
                    ...
                    <?php
                       ...
                       <tr>
                           <td colspan="2">
                            <div class="form-rotulo">Inscrição Municipal:</div>
    		                <div class="form-campos">
    		                        <input style="width:350px;" maxlength="100" type="text" name="inscricaoMunicipal" id="inscricaoMunicipal" value="<?php echo $dadosCliente['inscricaoMunicipal'];?>"/>
                            </div>
                        </td>
                           <td colspan="2">
