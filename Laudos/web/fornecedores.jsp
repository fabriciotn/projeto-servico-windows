...
<html>
    <head>
        ...
        <%
            ...
            List<Fornecedores> fornecedores = dao.getLista();
        %>
    ...
    <body>
        <div id="tudo">
            ...
            <div id="conteudo">
                <h2>Fornecedores</h2>
                <form method="post" action="ServletFornecedor" name="fornecedor">
                ...
                <table class="tb">
                    <tr>
                        ...
                        <td class="tbHeader">Fornecedor</td>
                ...
                <%
                    ...
                    for (Fornecedores fornecedor : fornecedores) {
                        if(i%2 == 0){
                            out.println("<tr>" +
                                "<td align=\"center\" class=\"tbDetail2\"><b>" + fornecedor.getId() + "</b></td>" +
                                "<td class=\"tbDetail2\">" + fornecedor.getNome() + "</td>" +
                                "<td align=\"center\" class=\"tbDetail2\"><a href=\"excluiFornecedor.jsp?id="+ fornecedor.getId() +"\">Excluir</a></td>" +
                                "</tr>");
                        }else{
                            out.println("<tr>" +
                                "<td align=\"center\" class=\"tbDetail1\"><b>" + fornecedor.getId() + "</b></td>" +
                                "<td class=\"tbDetail1\">" + fornecedor.getNome() + "</td>" +
                                "<td align=\"center\" class=\"tbDetail1\"><a href=\"excluiFornecedor.jsp?id="+ fornecedor.getId() +"\">Excluir</a></td>" +
                                "</tr>");
                        }
                        i++;
                    }
